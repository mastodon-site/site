...
<Card title="Do you want your own custom Mastodon username?" icon="signature" iconType="duotone" color="#069069" href="/managed-server/domain-name">
...
Since Mastodon is decentralized and there are many different servers (sometimes called instances) that make up the network, the `local` view is intended to only show you posts from the server you're logged into.
