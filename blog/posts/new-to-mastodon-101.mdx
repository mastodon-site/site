...
<Card title="Do you want your own customer Mastodon username?" icon="signature" iconType="duotone" color="#069069" href="/managed-instance/domain-name">
...
What often catches new Mastodon users out is if you follow a link to someone's profile but you're viewing it on their server - you can tell because the address bar will be their server and not yours. Your Mastodon username and password to log in only work on your local (home) server. Trying to follow a profile from their server will show a `Take me home` box. Instead of clicking follow here, you can copy their full username and search for it on yours.
