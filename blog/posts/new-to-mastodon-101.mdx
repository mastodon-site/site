...
### Different Mastodon views

In the website view of Mastodon, and in most of the apps, you'll see a few different ways to explore Mastodon

#### Local

Since Mastodon is decentralised and there are many different servers (or instances) that make up the network, the `local` view is intended to only show you posts from the instance you're logged into.
