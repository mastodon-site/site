...
The BBC's news Twitter accounts, especially its `@BBCBreaking` account, have historically been one of the first ways in which many people have gotten access to breaking news; if they replicate the content they already make to other social networks that could be a huge win for the group of open source projects like Mastodon, known commonly as the Fediverse.