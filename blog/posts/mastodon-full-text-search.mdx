---
title: "Full text search is coming to Mastodon"
...
Currently, most Mastodon servers are running the latest version, 4.1 - including all [Mastodon servers managed by mastodon.site](/mastodon-servers). By default the simple text search allows you to find display names, user names and hashtags. You cannot search the text of posts themselves.
