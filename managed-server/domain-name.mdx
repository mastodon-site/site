...
Even with a subdomain mastodon server running at `https://mastodon.business.com`, the users can still be set at the root - `info@business.com` or `the.boss@business.com`.

<Info>Full step-by-step guides are in [our support pages](/support/help-mastodon-dns-domain-names) if you need any help.</Info>