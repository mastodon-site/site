...
To keep our pricing fair, we try to charge based on your usage. We have a range of different server types to suit most people.

You can find the current price of our servers on the mastodon [server packages page](/mastodon-servers).
