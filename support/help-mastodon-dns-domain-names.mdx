...
At Mastodon.site, we don't register or manage domain names for you. If you decide to [bring your own domain name](/managed-server/domain-name), you'll need to update a few settings to get your server up and running.
...
You'll need to update those nameservers in order to use Mastodon.site with a domain name.
