...
description: "The service level agreement with mastodon.site"
icon: 'handshake'
---
...
- A monthly uptime of at least 99% for your core Mastodon server
- Mastodon security patches are rolled out within 24 hours

## How uptime is measured

We use a third party, UptimeRobot, to verifiably measure our uptime and response time. We publish these on our public status page at [https://status.mastodon.site](status.mastodon.site).

They check all our Mastodon services every minute of every day, and report it immediately if any issues take place. We'll also post updates to the public status page to explain causes for any incidents.
...
The service level agreement exludes any issues outside of our control, for example, if your domain name records are not correectly pointing to our servers.
