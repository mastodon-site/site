...
Want your own custom `name@mastodon.server`? We can help. [Bring your own domain name](/managed-server/domain-name) to a single-user server and let us do the work of running it for you.
