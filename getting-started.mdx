...
We'll ask you what you'd prefer to do once you start the subscription. We've also got [guides on configuring an existing domain name](/support/help-mastodon-dns-domain-names) if that's your choice.
