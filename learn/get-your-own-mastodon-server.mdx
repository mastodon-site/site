...
The first step is to create the new account on your chosen server. If you're stuck finding a new home, [https://fedi.garden](fedi.garden) and [https://joinmastodon.org/servers](joinmastodon.org/servers) are great resources; we can also [create and manage a mastodon server for you](https://mastodon.site/mastodon-servers)!
